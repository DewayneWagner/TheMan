...
namespace TheManXS.ViewModel.MapBoardVM.SKGraphics.Structures.CityStructures
{
    ...
    {
        SKRect _position;
        private const float _sideOfBuildingFromEdgeRatio = 0.1f;
        private const float _topOfBuildingFromTopRatio = 0.1f;
        private const float _spaceBetweenWindowsHorizontalRatio = 0.025f;
        private const float _spaceBetweenWindowsVerticalRatio = 0.01f;

        private const int _numberOfWindowsWide = 8;
        private const int _numberOfWindowsHigh = 25;
        ...
        public HighRiseBuilding(SKRect position, SKCanvas canvas)
        {
            _position = position;
